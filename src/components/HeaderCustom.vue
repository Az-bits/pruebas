      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html">
            <img src="@/assets/images/logo-dark.png" alt="Bookhunt" class="img-fluid" />
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbar2" role="button" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  Home<i class="fa fa-angle-down"></i>
                </a>
                <div class="dropdown-menu" aria-labelledby="navbar2">
                  <router-link class="dropdown-item" to="/">Home 1</router-link>
                  <router-link class="dropdown-item" to="/index2">Home dark</router-link>
                </div>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="#chapters" class="nav-link js-scroll-trigger">
                  Chapters
                </a>
              </li>
...
export default {
  created() {
    document.querySelector('body').removeAttribute('data-background')
